...
- We want a list of directions step-by-step
...
this path needs to be populated with a path that takes us through the whole room
traversal_path = []
backtrack until we find the nearest unexplored exit

keep a dict of neighbors and a boolean of whether the node has been traversed or not
